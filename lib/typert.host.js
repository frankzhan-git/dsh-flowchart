// dsh-flowchart 宿主线协议贡献（gateway 严格路径）：ctx.typert.register(TYPERT_HOST)
...
export const TYPERT_HOST = {
  package: 'dsh-flowchart',
  face: 'host',
  model: { name: 'dsh-flowchart', description: 'Mermaid 流程图库存储服务（CanvasStore 契约）' },
  schemas: [],
